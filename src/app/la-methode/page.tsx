    ...
    <div className="min-h-screen bg-[#07090C] text-[#F6F3EB] font-sans selection:bg-[#D8AA4D]/30 relative overflow-x-hidden">
      ...
      <section className="bg-[#0d1117] border-y border-white/5 py-24 px-6 text-center">
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          {/* Image de Philosophie / Autonomie */}
          <div className="max-w-2xl mx-auto rounded-3xl overflow-hidden border border-white/5 shadow-2xl relative aspect-[16/9] my-8">
            <Image 
              src="/methode-autonomie.png" 
              alt="Guidage vers l'autonomie" 
              fill
              className="object-cover hover:scale-105 transition-transform duration-700"
              sizes="(max-w-2xl) 100vw"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-[#07090C] via-transparent to-transparent opacity-80" />
            <div className="absolute bottom-4 left-6 text-left">
              <span className="text-[9px] font-black uppercase text-[#D8AA4D] tracking-widest bg-black/40 backdrop-blur-sm px-2 py-1 rounded">ACCOMPAGNEMENT VERS L'ENVOL</span>
              <p className="text-xs text-white font-bold mt-1">Nous vous guidons au début, pour que vous puissiez voler de vos propres ailes.</p>
            </div>
          </div>
      ...
      <section className="py-24 px-6 max-w-7xl mx-auto space-y-16">
        ...
        {/* Banner Écosystème Numérique - Centered dashboard screen mock */}
        <div className="max-w-2xl mx-auto rounded-3xl overflow-hidden border border-white/5 shadow-2xl relative aspect-[16/9] mb-12">
          <Image 
            src="/methode-ecosystem.png" 
            alt="Dashboard de Gestion OMRAYANAIR" 
            fill
            className="object-cover hover:scale-105 transition-transform duration-700"
            sizes="(max-w-2xl) 100vw"
          />
          ...
          <div className="absolute bottom-4 left-6 text-left">
            <span className="text-[9px] font-black uppercase text-[#D8AA4D] tracking-widest bg-black/40 backdrop-blur-sm px-2 py-1 rounded">LOGICIEL DE GESTION</span>
            <p className="text-xs text-white font-bold mt-1">Pilotez vos pèlerins, vols et hébergements depuis une interface unique en français.</p>
          </div>
        </div>
