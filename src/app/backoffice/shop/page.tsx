...
const INITIAL_PRODUCTS: Product[] = [
    ...
    },
    {
        ...
        description: 'Le roi des miels. Récolté dans la noble région du Hadramout au Yémen selon des méthodes ancestrales. Note spirituelle et linguistique : Ce miel est qualifié de « Sidr Malaki » (signifiant « Royal » en arabe) en raison de sa qualité suprême, et non « Maliki » (qui ferait référence par erreur à l\'école de jurisprudence).',
        price: 49.00,
        category: 'MIEL',
        image_url: '/la-voix-du-pelerin/assets/spiritual_prep.png',
        payment_link: '',
