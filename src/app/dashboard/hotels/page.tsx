        ...
        <div className="min-h-screen pb-12">
            ...
            <div className="max-w-3xl mx-auto p-6 space-y-8">
                ...
                <div className="space-y-6">
                    {hotelsData.length === 0 ? (
                        <div className="glass p-12 rounded-[2.5rem] border-emerald-500/5 text-center flex flex-col items-center justify-center min-h-[30vh]">
                            <Hotel className="w-12 h-12 text-dim opacity-30 mb-4 animate-pulse" />
                            <h3 className="font-bold text-main uppercase">Hébergements en cours de planification</h3>
                            <p className="text-xs text-dim max-w-xs mt-1">
                                Votre agence est en train de finaliser et de configurer vos séjours d'hôtels pour Makkah et Madinah. Les informations réelles apparaîtront ici dès qu'elles seront validées.
                            </p>
                        </div>
                    ) : (
                                ...
                                <div className="relative z-10 space-y-6">
                                    <div className="flex justify-between items-start">
                                        ...
                                        <div className="flex items-center gap-1">
                                            {hotel.stars && [...Array(hotel.stars)].map((_, i) => (
