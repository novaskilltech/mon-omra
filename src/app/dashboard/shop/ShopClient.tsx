                ...
                <div className="relative overflow-hidden rounded-[2.5rem] border border-emerald-500/15 bg-gradient-to-br from-[#0c1511]/90 to-[#070b09]/95 p-8 md:p-12 text-left shadow-2xl [transform-style:preserve-3d] [perspective:1000px] flex flex-col md:flex-row items-center justify-between gap-8">
                    ...
                    <div className="relative z-10 max-w-xl space-y-6">
                        ...
                        <div className="flex flex-wrap gap-4 pt-2">
                            ...
                            <a 
                                href="https://wa.me/33752280890?text=Bonjour,%20je%20souhaite%20obtenir%20des%20informations%20sur%20la%20boutique%20Terre%20Sainte%20Shop."
                                target="_blank"
                        ...
                        {PRODUCTS.map((prod) => (
                            <div key={prod.id} className="glass p-6 rounded-[2.5rem] border-emerald-500/5 flex flex-col justify-between shadow-sm relative group">
                                ...
                                <div className="mt-6 pt-4 border-t border-white/5">
                                    {prod.payment_link ? (
                                        <a
                                            href={`https://wa.me/33752280890?text=${encodeURIComponent(`Bonjour, je souhaite obtenir des informations sur le produit : ${prod.name}`)}`}
                                            target="_blank"
                                            rel="noopener noreferrer"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {SERVICES.map((srv) => (
                            <div key={srv.id} className="glass p-6 rounded-[2.5rem] border-amber-500/10 flex flex-col justify-between shadow-sm relative group">
                                ...
                                <div className="mt-6 pt-4 border-t border-white/5">
                                    <a
                                        href={`https://wa.me/33752280890?text=${encodeURIComponent(srv.whatsappMessage)}`}
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="w-full text-center bg-emerald-500 hover:bg-emerald-600 text-white font-bold text-xs uppercase tracking-widest py-3.5 rounded-2xl shadow-lg transition-all hover:scale-102 flex items-center justify-center gap-2"
                                    >
