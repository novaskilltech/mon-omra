...
import { ShoppingBag, ArrowLeft, Heart, ExternalLink, HelpCircle, Calendar, Users, MapPin, Compass } from 'lucide-react';
            ...
            <div className="max-w-5xl mx-auto space-y-8">
                ...
                <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                    <div className="space-y-1.5">
                        <span className="text-[10px] font-black uppercase tracking-[0.2em] text-emerald-500">BOUTIQUE & SERVICES</span>
                        ...
                        <p className="text-xs text-dim max-w-xl">
                            Commandez vos miels d'exception ou réservez vos activités et locations de chalets directement sur place à la Mecque et Médine.
                        </p>
                    </div>
                </header>
