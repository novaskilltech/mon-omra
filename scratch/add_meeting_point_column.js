...
async function run() {
    for (const r of regions) {
        ...
        try {
            ...
            await client.query('ALTER TABLE group_logistics ADD COLUMN IF NOT EXISTS meeting_point JSONB;');
            console.log("Column meeting_point JSONB added successfully (or already existed).");
            await client.end();
            return;
        } catch (e) {
